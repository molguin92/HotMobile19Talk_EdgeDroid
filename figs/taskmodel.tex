\begin{tikzpicture}[align=center,
    ...
    edge [bend left=20] node[above, anchor=south west] {\emph{In:} incorrect action\\\emph{Out:} none} (se)

    (se)
    edge [bend left=20] node[below, anchor=north east] {\emph{In:} undo action\\\emph{Out:} none} (si)
