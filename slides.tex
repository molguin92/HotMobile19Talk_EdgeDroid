        ...
        \begin{column}{.6\textwidth}
            \begin{center}
                \only<1>{%
                    ...
                    \includegraphics[width=.9\linewidth]{plots/rtt_fb_vs_nofb.pdf}\\%
                }%
                \only<2>{%
                    RTT by pipeline segments.\\
                    \includegraphics[width=.9\linewidth]{plots/box_feedback.pdf}\\%
                }%
                \only<3>{%
                    RTT by task step.\\
                    \includegraphics[width=.9\linewidth]{plots/box_taskstep.pdf}\\%
                }%
            \end{center}
        \end{column}
