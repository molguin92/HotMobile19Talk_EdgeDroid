...
\newcommand{\emailref}[1]{\href{mailto:#1}{\underline{\smash{#1}}}}
\newcommand{\telref}[1]{\href{tel:#1}{\underline{\smash{#1}}}}
\newcommand{\urlref}[1]{\href{#1}{\underline{\smash{#1}}}}
...
% color palette
\definecolor{C1}{HTML}{1954a6}
\definecolor{C2}{HTML}{98c1d9}
\definecolor{C3}{HTML}{e0fbfc}
\definecolor{C4}{HTML}{ee6c4d}
\definecolor{C5}{HTML}{293241}
